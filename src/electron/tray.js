...
// 菜单栏托盘图标：品牌白色 Zneox logo。配合 setTemplateImage(true) 作为模板图，
// macOS 按 alpha 通道着色——深色菜单栏显示白色、浅色显示黑色，深浅模式都可见。
const TRAY_ICON_PATH = path.join(__dirname, '..', '..', 'assets', 'icons', 'tray-zneox-white.png');
